...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  Connection:
    ...
    | (Omit<ItemConnection, 'edges'> & { edges: Array<_RefType['ItemEdge']> })
    | (Omit<UserConnection, 'edges'> & { edges: Array<_RefType['UserEdge']> });
  Edge:
    | (Omit<CommentEdge, 'node'> & { node: _RefType['Comment'] })
    | (Omit<ItemEdge, 'node'> & { node: _RefType['ItemList'] })
    | (Omit<UserEdge, 'node'> & { node: _RefType['User'] });
};
...
export type ResolversTypes = {
  ...
  Comment: ResolverTypeWrapper<
    Omit<Comment, 'children' | 'user'> & {
      children?: Maybe<ResolversTypes['Comment']>;
  ...
  ItemConnection: ResolverTypeWrapper<
    Omit<ItemConnection, 'edges'> & { edges: Array<ResolversTypes['ItemEdge']> }
  >;
...
export type ResolversParentTypes = {
  ...
  Comment: Omit<Comment, 'children' | 'user'> & {
    children?: Maybe<ResolversParentTypes['Comment']>;
  ...
  ItemConnection: Omit<ItemConnection, 'edges'> & {
    edges: Array<ResolversParentTypes['ItemEdge']>;
  };
...
> = {
  __resolveType: TypeResolveFn<
    'CommentConnection' | 'ItemConnection' | 'UserConnection',
    ParentType,
    ContextType
  >;
...
> = {
  ...
  comments?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<ItemDetailCommentsArgs>
  >;
...
> = {
  ...
  collectItem?: Resolver<
    ResolversTypes['ItemDetail'],
    ParentType,
    ContextType,
    RequireFields<MutationCollectItemArgs, 'itemId'>
  >;
  createItem?: Resolver<
  ...
  followUser?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationFollowUserArgs, 'followerId' | 'followingId'>
  >;
  generateUploadUrl?: Resolver<
    Array<ResolversTypes['FileUploadResponse']>,
    ParentType,
    ContextType,
    RequireFields<MutationGenerateUploadUrlArgs, 'files'>
  >;
  loginWithCode?: Resolver<
    ResolversTypes['AuthPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationLoginWithCodeArgs, 'code' | 'email'>
  >;
  logout?: Resolver<
    ResolversTypes['GenericResponse'],
    ParentType,
  ...
  >;
  uncollectItem?: Resolver<
    ResolversTypes['ItemDetail'],
    ParentType,
    ContextType,
    RequireFields<MutationUncollectItemArgs, 'itemId'>
  >;
  unfollowUser?: Resolver<
    ResolversTypes['GenericResponse'],
    ParentType,
    ContextType,
    RequireFields<MutationUnfollowUserArgs, 'followerId' | 'followingId'>
  >;
};
...
> = {
  ...
  categories?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryCategoriesArgs, 'id'>
  >;
  item?: Resolver<
    Maybe<ResolversTypes['ItemDetail']>,
    ParentType,
    ContextType,
  ...
  items?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryItemsArgs, 'first'>
  >;
  me?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  topLevelCategories?: Resolver<
    Array<Maybe<ResolversTypes['Categories']>>,
    ParentType,
    ContextType
  >;
  user?: Resolver<
...
> = {
  ...
  followers?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserFollowersArgs, 'first'>
  >;
  following?: Resolver<
    ResolversTypes['UserConnection'],
    ParentType,
    ContextType,
    RequireFields<UserFollowingArgs, 'first'>
  >;
